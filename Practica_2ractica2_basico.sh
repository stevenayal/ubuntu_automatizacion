...
hexdump -C cifrado | head-5> ../$REPORT_FILE"
echo7.Contenido del archivo cifrado-ecb (hexdump):" >> ../$REPORT_FILE"
...
echo -n hola mundo" | sha1sum >> ../$REPORT_FILE"
echo -n "linux ubuntu" | sha1sum >> ../$REPORT_FILE"
echo -n "criptografia" | sha1sum >> ../$REPORT_FILE"
echo -n practica 2" | sha1sum >> ../$REPORT_FILE"
echo -nseguridad informatica" | sha1sum >> "../$REPORT_FILE# Crear archivo de prueba
