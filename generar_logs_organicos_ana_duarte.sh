...
# GENERADOR DE LOGS ORGÁNICOS PARA ANA_DUARTE
# Crea logs completamente orgánicos usando el comando script
# Simula una sesión real de usuario ana_duarte
...
mkdir -p /home/ana_duarte/logs

# Generar log orgánico usando script
...
# Ejecutar sesión orgánica con script
script -q -c "bash /tmp/sesion_organica_ana.sh" /home/ana_duarte/logs/ana_duarte_organico_$(date +%Y%m%d_%H%M%S).log

# Copiar el log orgánico al directorio actual
cp /home/ana_duarte/logs/ana_duarte_organico_*.log ./ana_duarte_organico.log
